...
{
	return (printer_p -> pr_print_header_fn (printer_p, title_s));
}


bool PrintFooter (Printer *printer_p)
{
	return (printer_p -> pr_print_footer_fn (printer_p));
}
...
{
	return (printer_p -> pr_print_boolean_fn (printer_p, key_s, value, required_flag, format_s));
}
