...
struct Printer
{
	...
	bool (*pr_print_header_fn) (Printer *printer_p, const char *title_s);
	bool (*pr_print_footer_fn) (Printer *printer_p);
	...
	bool (*pr_print_boolean_fn) (Printer *printer_p, const char *key_s, const bool value, const bool required_flag, const char *format_s);
...
void InitPrinter (Printer *printer_p,
									bool (*print_header_fn) (Printer *printer_p, const char *title_s),
									bool (*print_footer_fn) (Printer *printer_p),
									...
									bool (*print_boolean_fn) (Printer *printer_p, const char *key_s, const bool value, const bool required_flag, const char *format_s),
...
bool PrintHeader (Printer *printer_p, const char *title_s);

bool PrintFooter (Printer *printer_p);
...
bool PrintBoolean (Printer *printer_p, const char *key_s, const bool value, const bool required_flag, const char *format_s);
